...
class patientsInfo(models.Model):
    ...
    # patientImage = models.ImageField(upload_to=os.path.join(BASE_DIR, 'patientsUploadedImage'))
    patientImage = models.ImageField(upload_to='static/patientsUploadedImage')
